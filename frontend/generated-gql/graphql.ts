...
export type FindCoacheeByIdQuery = { __typename?: 'Query', findCoacheeByID: { __typename?: 'Coachee', id: number, firstName: string, lastName: string, email: string, password: string, bio: string, address: string, interests: Array<{ __typename?: 'CoacheeInterest', type: string, name: string }> } };
...
export type FindCoachByIdQuery = { __typename?: 'Query', findCoachByID: { __typename?: 'Coach', id: number, firstName: string, lastName: string, email: string, password: string, bio: string, address: string, interests: Array<{ __typename?: 'CoachInterest', type: string, name: string }>, sports: Array<{ __typename?: 'Sport', type: string }> } };
