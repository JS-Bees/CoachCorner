...
export type FindCoacheesOfCoachQuery = { __typename?: 'Query', findCoachByID: { __typename?: 'Coach', contacts: Array<{ __typename?: 'Contact', id: number, coacheeId: number, contactedStatus: boolean, coachee: { __typename?: 'Coachee', firstName: string, lastName: string, profilePicture: string } }> } };
