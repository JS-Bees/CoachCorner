...
export type CreateBookingMutation = { __typename?: 'Mutation', createBooking: { __typename?: 'Booking', id: number, coacheeId: number, coachId: number, serviceType: string, status: BookingStatus, additionalNotes?: string | null, bookingSlots: Array<{ __typename?: 'BookingSlot', id: number, bookingId: number, date: any, startTime: any, endTime: any }> } };
...
export type FindBookingByIdQuery = { __typename?: 'Query', findBookingByID: { __typename?: 'Booking', id: number, coacheeId: number, coachId: number, serviceType: string, status: BookingStatus, additionalNotes?: string | null, bookingSlots: Array<{ __typename?: 'BookingSlot', id: number, bookingId: number, date: any, startTime: any, endTime: any }> } };
...
export type FindUnaddedCoachesBySportQuery = { __typename?: 'Query', findUnaddedCoachesBySport: Array<{ __typename?: 'Coach', id: number, firstName: string, lastName: string, email: string, sport: Sport, bio?: string | null, workplaceAddress: string, affiliations?: string | null, coachingRelationships: Array<{ __typename?: 'CoachingRelationship', coacheeId: number }> }> };
