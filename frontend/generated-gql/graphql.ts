...
export type FindUnaddedCoachesBySportQuery = { __typename?: 'Query', findUnaddedCoachesBySport: Array<{ __typename?: 'Coach', id: number, firstName: string, lastName: string, email: string, sport: Sport, coachingRelationships: Array<{ __typename?: 'CoachingRelationship', coacheeId: number }> }> };
