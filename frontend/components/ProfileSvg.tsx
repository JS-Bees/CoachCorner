...
function ProfileSvg (props: any) {
    return(
        ...
        >
          ...
          <Path fill="#BAABC8" d="M0 6.00001C0 -7.25483 10.7452 -18 24 -18H336C349.255 -18 360 -7.25483 360 6V195C360 208.255 349.255 219 336 219H24C10.7452 219 0 208.255 0 195V6.00001Z" />  
          <Path 
